...
def genderapp():
    if request.method == 'POST':
        ...
        for i , obj in enumerate(predictions):
            ...
            matimg.imsave(f'./static/predict/{gray_image_name}',gray_image,cmap='gray') # cmap - converts to greyscale 
            matimg.imsave(f'./static/predict/{eig_image_name}',eigen_image,cmap='gray')

            # Using matplotlib image saver beacause the image saved will be in 0 - 1 format 
            # and cv2 uses 0 to 255.
